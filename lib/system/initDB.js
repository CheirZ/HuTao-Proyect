...
function initDB(m, client) {
  ...
  settings.self ??= false
  settings.prefijo ??= ['/', '.', '!', '#',]
  settings.id ??= '120363407128588763@newsletter'
  settings.nameid ??= '✦͙͙͙*͙*❥⃝∗⁎.ʚ ʰᵘᵗᵃᵒ-ᵖʳᵒʸᵉᶜᵗ ɞ.⁎∗❥⃝**͙✦͙͙͙'
  settings.link ??= 'https://api.stellarwa.xyz'
  settings.banner ??= 'https://raw.githubusercontent.com/CheirZ/Repo-img/refs/heads/main/Furina-proyect/1767585523669.jpg'
  settings.icon ??= 'https://raw.githubusercontent.com/CheirZ/Repo-img/refs/heads/main/Furina-proyect/1766201596136.jpg'
  settings.currency ??= 'moras'
  settings.namebot ??= 'ɦʊȶǟօ-քʀօʏɛƈȶ'
  settings.namebot2 ??= 'HuTao'
  settings.owner ??= 'Xi_miguelon77xx'
  settings.canal ??= 'https://whatsapp.com/channel/0029VbC5ao86rsQmz5FIjt2G'
