...
if (!img) return conn.reply(m.chat, `> y la imagen o video pedazo de animal?*`, m, gp4)
...
else return conn.reply(m.chat, '> ⚠︎ Responde a una imagen o un video de 8s :3', m, gp4)
