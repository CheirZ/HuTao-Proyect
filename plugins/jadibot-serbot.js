...
await parentw.reply(conn.user.jid, "☢︎︎ Conexión perdida con el servidor.", m)
}
}
...
await parentw.reply(conn.user.jid, `𖧷 *Para volver a vincular un sub Bot use su token*`, m, rcanal)
}
}
...
fs.rmdirSync(`./jadibot/${serbotFolder}`, { recursive: true })
}
}, 30000)
