...
if (new Date - global.db.data.users[m.sender].Subs < 120000) return conn.reply(m.chat, `🕝 Debes esperar ${msToTime(time - new Date())} para volver a intentar vincular un subbot.`, m)
